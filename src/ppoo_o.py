...
#BOPO não tem critic: o único modelo treinado é o ator, que atribui um score a cada
#operação candidata (ação a nível de nó nesta representação). Sem baseline/valor de estado,
#porque a loss do BOPO (SROLoss) compara diretamente a log-likelihood de trajetórias
#completas, em vez de usar uma vantagem.
